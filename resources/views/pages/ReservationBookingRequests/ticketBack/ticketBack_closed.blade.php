                        ...
                        @if(count($tripSeats) == count($tripSeats))  <!-- عدد مقاعد الرحلة = عدد مقاعد الأسطول التي تتبع له الرحلة -->
                             <div class="row">
                                <div class="col-md-6" style="border-left:2px solid #ddd">
                                    ...
                                    <form class="inside" action="{{route('reservationBookingRequests.calc_ticket_back_closed')}}" method="post" enctype="multipart/form-data" style="position:absolute; bottom:0; width:100%; height:80%;">
                                        @csrf
                                           ...
                                           <tr>
                                            ...
                                            @foreach($bookedSeats as $bookedSeat)
                                                <tr class="{{$loop->index}}">
                                                    ...
                                                    <td class="old_seat"><input type="text" name="oldSeats[]" value="{{$bookedSeat->seat_id}}" readonly/></td>
