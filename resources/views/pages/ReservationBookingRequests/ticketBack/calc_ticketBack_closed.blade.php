                        ...
                        @if(count($tripSeats) == count($tripSeats))  <!-- عدد مقاعد الرحلة = عدد مقاعد الأسطول التي تتبع له الرحلة -->
                             <div class="row">
                                <div class="col-md-6" style="border-left:2px solid #ddd">
                                    ...
                                    <form class="inside" action="{{route('reservationBookingRequests.save_ticket_back_closed')}}" method="post" enctype="multipart/form-data" style="position:absolute; bottom:0; width:100%; height:95%;">
                                        @csrf
