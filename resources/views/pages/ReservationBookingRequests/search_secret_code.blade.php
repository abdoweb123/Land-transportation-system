<!-- add_modal_city -->
<div class="modal fade" id="search_secret_code" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif; text-align:center" class="modal-title" id="exampleModalLabel">
                   عرض التذكرة باستخدام الرقم السري
                </h5>
            ...
            <div class="modal-body">
                <!-- add_form -->
                <form action="{{route('reservationBookingRequests.getTicketDesign')}}" method="get" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col">
                            <label  for="title" class="mr-sm-2">اخل الرقم السري :</label>
