<!-- add_modal_station -->
<div class="modal fade" id="create_new_runTrip" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document" style="min-width:80%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- add_form -->
                <form action="{{ route('create_new_run_trip') }}" method="post" enctype="multipart/form-data">
                    @csrf
