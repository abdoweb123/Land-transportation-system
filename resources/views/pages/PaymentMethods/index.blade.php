...
@section('content')
    ...
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            @foreach ($paymentMethods as $item)
                                ...
                                @include('pages.PaymentMethods.edit')

                                <!--  page of delete_modal_city -->
                                @include('pages.PaymentMethods.delete')


                            @endforeach
                        </table>

                        <div> {{$paymentMethods->links('pagination::bootstrap-4')}}</div>
                    </div>
                </div>
            </div>
        </div>
       ...
       @include('pages.PaymentMethods.create')
    </div>
